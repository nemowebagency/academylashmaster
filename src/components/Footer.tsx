        ...
        <div className="grid md:grid-cols-3 gap-8 sm:gap-12 lg:gap-16 mb-8 sm:mb-12">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center md:justify-start space-x-4 sm:space-x-6">
              ...
              <a href="https://www.instagram.com/academy_lash_master_anamaria/?igsh=eDUzbDVlNGdnbHUx&utm_source=qr#" target="_blank" rel="noopener noreferrer" className="text-gray-200 hover:text-white transition duration-300" aria-label="Segui Academy Lash Master su Instagram">
                <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="currentColor" viewBox="0 0 24 24">
