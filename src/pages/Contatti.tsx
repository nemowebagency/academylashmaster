          ...
          <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-start">
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-semibold text-white mb-1">Telefono</h4>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-semibold text-white mb-1">Email</h4>
              ...
              <div className="flex items-center">
                ...
                <div>
                  <h4 className="text-lg sm:text-xl font-semibold text-white mb-1">Indirizzo</h4>
